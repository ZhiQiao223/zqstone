...
import com.zhiqiao.zqstone.analysis.node.ArrayNode;
import com.zhiqiao.zqstone.analysis.node.ChunkNode;
import com.zhiqiao.zqstone.analysis.node.CommandNode;
import com.zhiqiao.zqstone.analysis.node.DefineFunctionNode;
import com.zhiqiao.zqstone.analysis.node.DefineVariableNode;
import com.zhiqiao.zqstone.analysis.node.ElementNode;
import com.zhiqiao.zqstone.analysis.node.ElementNode.ElementType;
import com.zhiqiao.zqstone.analysis.node.OperateNode;
import com.zhiqiao.zqstone.analysis.node.StartChunkNode;
import com.zhiqiao.zqstone.analysis.node.WhenNode;
import com.zhiqiao.zqstone.analysis.node.ExpressionNode;
import com.zhiqiao.zqstone.analysis.node.ForEachLoopNode;
import com.zhiqiao.zqstone.analysis.node.IfElseNode;
import com.zhiqiao.zqstone.analysis.node.InvokerNode;
import com.zhiqiao.zqstone.analysis.node.LambdaNode;
import com.zhiqiao.zqstone.analysis.node.LoopChunkNode;
import com.zhiqiao.zqstone.analysis.node.TryCatchNode;
...
class AnalysisDefine {
    ...
    static {
        ...
        creator(new Exp[] {Exp.Container}, () -> {
            return new ElementNode() {
                {
                    container = new com.zhiqiao.zqstone.analysis.node.ContainerNode();
